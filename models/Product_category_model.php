...
class Product_category_model extends App_Model
{
    ...
    public function get_by_branch($branch_id = false){
        if (is_numeric($branch_id)) {
            $categories = $this->db->get_where(db_prefix().'product_categories', array('product_branch_id' => $branch_id));
            return $categories;
        }
        $categories = $this->db->get(db_prefix() . 'product_categories')->result_array();
        return $categories;
    ...
    public function edit($data)
    {
        ...
        $res = $this->db->update(db_prefix().'product_categories', [
            'product_branch_id'        => $data['product_branch_id'],
