                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="form-group" app-field-wrapper="product_code">
                            <label for="product_code" class="control-label"> <small
                                        class="req text-danger">* </small><?php echo _l('product_code') ?></label>
                            <div class="relative">
                                ...
                                <span id="productAddBarcodeBtn" class="btn btn-info">
                                    <i>
                                        <svg id="Capa_1" stroke="white" stroke-width="10"
                                             ...
                                             viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg"><g><path
                                                        d="m196.992 234.287h-179.497c-9.646 0-17.495 7.848-17.495 17.495v119.687c0 9.646 7.849 17.495 17.495 17.495h179.497c9.646 0 17.494-7.848 17.494-17.495v-119.687c0-9.647-7.847-17.495-17.494-17.495zm2.494 137.182c0 1.375-1.119 2.495-2.494 2.495h-179.497c-1.376 0-2.495-1.119-2.495-2.495v-119.687c0-1.375 1.119-2.495 2.495-2.495h179.497c1.375 0 2.494 1.119 2.494 2.495z"/><path
                                                        d="m163.051 265.019c-4.143 0-7.5 3.358-7.5 7.5v78.214c0 4.142 3.357 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-78.214c0-4.143-3.358-7.5-7.5-7.5z"/><path
                                                        d="m135.147 265.019c-4.143 0-7.5 3.358-7.5 7.5v78.214c0 4.142 3.357 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-78.214c0-4.143-3.357-7.5-7.5-7.5z"/><path
                                                        d="m107.243 265.019c-4.143 0-7.5 3.358-7.5 7.5v78.214c0 4.142 3.357 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-78.214c0-4.143-3.357-7.5-7.5-7.5z"/><path
                                                        d="m51.436 265.019c-4.143 0-7.5 3.358-7.5 7.5v78.214c0 4.142 3.357 7.5 7.5 7.5s7.5-3.358 7.5-7.5v-78.214c0-4.143-3.358-7.5-7.5-7.5z"/><path
                            ...
                            <?php if (!empty($product->image_url)) { ?>
                                <div class="<?php echo htmlspecialchars($existing_image_class); ?>">
                                    <div class="existing_image">
                                        ...
                                        <img src="<?php echo base_url('modules/' . PRODUCTS_MODULE_NAME . '/uploads/' . $product->image_url); ?>"
                                             class="img img-responsive img-thubnail zoom"/>
                                    </div>
                                </div>
                            <?php } ?>
                    ...
                    <!-- livestream_scanner-->
                    <div class="modal fade" id="livestream_scanner" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document" id="livestream_scannerModal">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger mclose" data-dismiss="modal">Close
                                    </button>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    let currentBranchId = $('#branch_id').val();
    let currentCatId = '<?php echo isset($product) ? $product->category_id : null ?>';
    let currentSubCatId = '<?php echo isset($product) ? $product->subcategory_id : null ?>';
    let mode = '<?php echo '' . $this->uri->segment(3, 0); ?>';
    ...
    function barcodeScan() {
        ...
        let App = {
            ...
            activateScanner: function () {
                let last_results = [];
                let scanner = this.configureScanner('#interactive'),
                    onDetected = function (result) {
                        ...
                        if (last_results.length > 20) {
                            ...
                            last_results = [];
                            let audio = $("#scannerBeepSoundClip")[0];
                            audio.play();
